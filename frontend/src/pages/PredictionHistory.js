                ...
                {predictions.length === 0 ? (
                  ...
                  predictions.map((pred) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        {pred.outcome7d === "WIN" ? (
                          <span className="px-3 py-1 rounded-full text-sm font-semibold bg-green-100 text-green-900">
                            WIN
                          </span>
                        ) : pred.outcome7d === "LOSS" ? (
                          <span className="px-3 py-1 rounded-full text-sm font-semibold bg-red-100 text-red-900">
                            LOSS
                          </span>
                        ) : (
